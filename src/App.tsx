...
function AuditPage({personas,pages,auditData,setAuditData,onAddAction,onSaveWireframe,setView}){
...
function WireframesPage({wireframes,setWireframes,onDeleteWireframe,onUpdateWireframe,auditData,personas,onSaveWireframe,onAddRec,onRemoveRec,lovedComponents,onLoveComponent,onUnloveComponent}:any){
            ...
            <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:16}}>
              ...
              {!editing&&(
                <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0,paddingTop:2}}>
                  ...
                  <span style={{fontSize:11,fontWeight:600,color:"rgba(255,255,255,0.25)",letterSpacing:"0.02em",flexShrink:0,userSelect:"none"}}>✎ double-click to edit</span>
