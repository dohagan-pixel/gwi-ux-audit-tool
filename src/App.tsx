            ...
            <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:16}}>
              <div style={{flex:1,minWidth:0}}>
                ...
                {editing?(
                  ...
                  <>
                    <h2 style={{color:C.white,fontSize:22,fontWeight:800,margin:"0 0 4px"}}>{(function(){var _ps=(pages||[]).find(function(p:any){return p.url===active.pageUrl;});return(_ps&&_ps.label)||active.pageLabel;}())}</h2>
